    ...
    stages {
        ...
        stage('cleanDb') {
           steps {
               ...
               bat './gradlew.bat flywayClean -P flyway.user=bib -P flyway.password=password -P flyway.schemas=order -P flyway.url=jdbc:mysql://localhost:3306/orders'
               bat './gradlew.bat flywayMigrate -P flyway.user=bib -P flyway.password=password -P flyway.schemas=order -P flyway.url=jdbc:mysql://localhost:3306/orders'
           }
        }
